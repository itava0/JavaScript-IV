...
//   GameObject.call(this, element)
//   this.healthPoints = element.healthPoints;
// }
...
class CharacterStats extends GameObject {
  constructor(CharacterStatsElement){
    super(CharacterStatsElement);
    this.healthPoints = CharacterStatsElement.healthPoints;
  }
  takeDamage() {
    return `${this.name} took damage.`;
  }
}//this closes the CharacterStats
/*
...
class Humanoid extends CharacterStats {
  constructor(HumanoidElement){
    super(HumanoidElement);
    this.team = HumanoidElement.team;
    this.weapons = HumanoidElement.weapons;
    this.language = HumanoidElement.language;
  }
  greet() {
    return `${this.name} offers a greeting in ${this.language}`;
  }
}//this closes the Humanoid
/*
